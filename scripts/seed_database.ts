...
async function seedWatchlistPairs(userId: string): Promise<void> {
  ...
  if (!watchlist) {
    const { data: newWl, error } = await supabase
      ...
      .single();
    if (error) {
      console.error("❌ Watchlist create error:", error.message);
      return;
    }
    watchlist = newWl;
  }
  ...
  const signals = [
    {
      ...
      entry: 104500,
      stop_loss: 102800,
      take_profit: [108000, 112000],
      reasons: [
        "Bullish engulfing at key support",
        "RSI oversold bounce on 4H",
        "Volume surge at demand zone",
      ],
      ...
      liquidity_zones: [
        { level: 102500, type: "demand" },
        { level: 108500, type: "supply" },
      ],
    ...
    },
    {
      ...
      liquidity_zones: [
        { level: 3390, type: "demand" },
        { level: 3640, type: "supply" },
      ],
      signal_date: "2026-06-24",
    },
    {
      ...
      entry: 178,
      stop_loss: 172,
      take_profit: [185, 195, 210],
      reasons: [
        "Breaking ascending triangle resistance",
        "On-chain volume 3x average",
        "Meme sector rotation into SOL",
      ],
      ...
      liquidity_zones: [
        { level: 173, type: "demand" },
        { level: 186, type: "supply" },
      ],
      signal_date: "2026-06-24",
    },
    {
      ...
      liquidity_zones: [
        { level: 0.163, type: "demand" },
        { level: 0.184, type: "supply" },
      ],
      signal_date: "2026-06-24",
    },
    {
      ...
      entry: 0.0000142,
      stop_loss: 0.0000155,
      take_profit: [0.0000125, 0.000011],
      reasons: [
        "Bearish divergence on RSI",
        "Rejected at 0.618 Fibonacci",
        "Volume declining on highs",
      ],
      pattern: "Bearish Divergence",
      market_structure: {
        trend: "bearish",
        swing_high: 0.0000158,
        swing_low: 0.000012,
        structure: "lower_highs",
      },
      liquidity_zones: [
        { level: 0.0000125, type: "demand" },
        { level: 0.0000155, type: "supply" },
      ],
      signal_date: "2026-06-24",
    },
    {
      ...
      liquidity_zones: [
        { level: 2.6, type: "demand" },
        { level: 3.35, type: "supply" },
      ],
      signal_date: "2026-06-24",
    },
    {
      ...
      entry: 103000,
      stop_loss: 98000,
      take_profit: [110000, 125000],
      reasons: [
        "Weekly MA cross bullish",
        "Halving cycle alignment",
        "Institutional inflows +$2.1B weekly",
      ],
      ...
      market_structure: {
        ...
        swing_high: 109000,
        swing_low: 89000,
        structure: "macro_uptrend",
      },
      liquidity_zones: [
        { level: 99000, type: "demand" },
        { level: 110000, type: "supply" },
      ],
    ...
    },
    {
      ...
      take_profit: [185, 200],
      reasons: [
        "Firedancer upgrade catalyst",
        "DeFi TVL ATH on Solana",
        "Meme coin launchpad dominance",
      ],
      ...
      liquidity_zones: [
        { level: 166, type: "demand" },
        { level: 194, type: "supply" },
      ],
    ...
    },
    {
      ...
      entry: 0.000015,
      stop_loss: 0.0000162,
      take_profit: [0.000013, 0.000011],
      reasons: [
        "Rising wedge breakdown",
        "On-chain selling pressure from top holders",
        "Market cap divergence from volume",
      ],
      ...
      liquidity_zones: [
        { level: 0.000011, type: "demand" },
        { level: 0.000016, type: "supply" },
      ],
      signal_date: "2026-06-22",
    },
  ];
