...
function p(t, opts = {}) {
  return new Paragraph({
    ...
    children: [
      new TextRun({ text: t, size: 22, color: c(P.body), font: { ascii: "Calibri" }, ...opts }),
    ],
  });
}
function bold(t) {
...
function makeProblemRow(id, severity, title, file, status, roadmap, isNew) {
  ...
  return new TableRow({
    ...
    children: [
      cell(id, 8),
      cell(severity, 12, { color: sevColor, bold: true }),
      cell(title, 30),
      cell(file, 25),
      cell(status, 10, { color: status === "Open" ? P.red : P.green }),
      cell(roadmap, 10),
      cell(isNew, 5),
    ],
  });
  ...
  return new TableCell({
    ...
    children: [
      new Paragraph({
        spacing: { after: 0 },
        children: [
          new TextRun({ text, size: 18, color: "FFFFFF", bold: true, font: { ascii: "Calibri" } }),
        ],
      }),
    ],
  });
...
const problems = [
  ...
  [
    "#01",
    "CRITICAL",
    "Charts do not work in Telegram WebView",
  ...
  [
    "#02",
    "CRITICAL",
    "AssetRegistry is a static bottleneck (18 assets only)",
    "asset-registry/types.ts",
    "Open",
    "Phase C2",
    true,
  ],
  [
    "#03",
    "CRITICAL",
    "Home page shows derived data not real portfolio",
  ...
  [
    "#04",
    "CRITICAL",
    "Portfolio data derived from trades, not real balances",
    "shared/data/index.ts",
    "Open",
    "Phase C3",
    true,
  ...
  [
    "#05",
    "CRITICAL",
    "Token detail page is empty for most tokens",
  ...
  [
    "#06",
    "HIGH",
    "Arbitrage scanner returns mock empty response",
    "shared/data/index.ts:1321",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#07",
    "HIGH",
    "Swap page uses hardcoded static prices",
    "swap-component.tsx:12",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#08",
    "HIGH",
    "Swap page has mock balances (MOCK_BALANCES)",
    "swap-component.tsx:50",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#09",
    "HIGH",
    "OHLCV fallback generates fake deterministic offsets",
    "market/functions.ts:160",
    "Open",
    "Phase C3",
    false,
  ],
  [
    "#10",
    "HIGH",
    "Market news returns empty without FINNHUB_API_KEY",
    "market/functions.ts:31",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#11",
    "HIGH",
    "Whale page shows users own trades, not real whales",
    "shared/data/index.ts:773",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#12",
    "HIGH",
    "Pulse page shows users own activity, not market pulse",
    "shared/data/index.ts:989",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#13",
    "HIGH",
    "Alpha signals only from user data, not real alpha",
    "shared/data/index.ts:912",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#14",
    "HIGH",
    "Bonding curves computed from user trades, fake data",
    "shared/data/index.ts:819",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#15",
    "HIGH",
    "Communities page shows user strategies, not real community",
    "shared/data/index.ts:715",
    "Open",
    "Deferred",
    false,
  ],
  ...
  [
    "#16",
    "HIGH",
    "Symbol maps duplicated in 3+ files",
    "TradingViewChart.tsx, -token-symbol-component.tsx, asset-registry/types.ts",
    "Open",
    "Phase C2",
    false,
  ],
  [
    "#17",
    "HIGH",
    "Price data sources fragmented (5+ providers)",
    "shared/market-data/",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#18",
    "HIGH",
    "No centralized price cache strategy",
    "shared/cache.ts",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#19",
    "HIGH",
    "Arbitrage domain has unused complex architecture",
    "domains/arbitrage/",
    "Open",
    "Deferred",
    false,
  ...
  [
    "#20",
    "HIGH",
    "N+1 API calls in discover-crypto-data enrichment",
    "discover/discover-crypto-data.ts:74",
    "Open",
    "Phase C1",
    false,
  ],
  ...
  [
    "#21",
    "HIGH",
    "DexChart CSS vars may not resolve in all contexts",
    "components/vixor/DexChart.tsx:42",
    "Open",
    "Phase C1",
    false,
  ],
  [
    "#22",
    "HIGH",
    "No fallback when TradingView fails in restricted env",
    "components/vixor/TradingViewChart.tsx",
    "Open",
    "Phase C1",
    false,
  ],
  [
    "#23",
    "HIGH",
    "TradingViewChart uses Math.random for container ID",
    "components/vixor/TradingViewChart.tsx:107",
    "Open",
    "Phase C1",
    false,
  ],
  ...
  [
    "#24",
    "MEDIUM",
    "Home page greeting is English-only (not localized)",
    "routes/_authenticated/index.tsx:38",
    "Open",
    "Phase C4",
    false,
  ],
  [
    "#25",
    "MEDIUM",
    "New users see empty state on most pages",
    "Multiple pages",
    "Open",
    "Phase C4",
    false,
  ...
  [
    "#26",
    "MEDIUM",
    "Forex/commodity token detail uses TradingView (fails in Tg)",
    "-token-symbol-component.tsx:395",
    "Open",
    "Phase C1",
    false,
  ],
  [
    "#27",
    "MEDIUM",
    "Gold price uses ECB/Frankfurter exchange rates",
    "shared/data/index.ts:1343",
    "Open",
    "Phase C3",
    false,
  ],
  [
    "#28",
    "MEDIUM",
    "Discover forex data uses Math.random",
    "-discover-forex-data.ts",
    "Open",
    "Phase C3",
    false,
  ],
  [
    "#29",
    "MEDIUM",
    "BTC dominance hardcoded to 0 as initial fallback",
    "shared/data/index.ts:1251",
    "Open",
    "Phase C3",
    false,
  ],
  [
    "#30",
    "MEDIUM",
    "Duplicated utility functions (fmtPrice, fmtCompact) in 5+ files",
    "Multiple files",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#31",
    "MEDIUM",
    "Excessive `any` type usage in data mapping",
    "shared/data/index.ts",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#32",
    "MEDIUM",
    "Dead code: token-symbol-component.tsx alongside -token-symbol-component.tsx",
  ...
  [
    "#33",
    "MEDIUM",
    "Missing error handling in several server functions",
    "shared/data/index.ts",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#34",
    "MEDIUM",
    "Experiments page has placeholder content",
    "routes/_authenticated/experiments.tsx",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#35",
    "MEDIUM",
    "Daily Loop component has TODO/placeholder markers",
    "-daily-loop-component.tsx",
    "Open",
    "Deferred",
    false,
  ],
  ...
  [
    "#36",
    "MEDIUM",
    "No rate limiting on DexScreener client calls",
    "domains/discovery/clients/dexscreener.client.ts",
    "Open",
    "Phase C2",
    false,
  ],
  [
    "#37",
    "MEDIUM",
    "Binance API called without API key (rate-limited)",
    "shared/data/index.ts:1228",
    "Open",
    "Phase C2",
    false,
  ],
  [
    "#38",
    "MEDIUM",
    "No retry/backoff for failed external API calls",
    "market/functions.ts",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#39",
    "MEDIUM",
    "WebSocket connections lack error boundaries",
    "shared/market-data/",
    "Open",
    "Phase C2",
    false,
  ...
  [
    "#40",
    "MEDIUM",
    "No input validation on token symbol in token detail",
    "-token-symbol-component.tsx:254",
    "Open",
    "Phase C2",
    false,
  ],
  ...
  [
    "#41",
    "LOW",
    "Backtest engine uses simulated data",
    "domains/backtest/engine/",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#42",
    "LOW",
    "Trading gateway has dummy-adapter (mock)",
    "domains/trading/gateway/adapters/dummy-adapter.ts",
    "Open",
    "Deferred",
    false,
  ],
  [
    "#43",
    "LOW",
    "Copilot AI may return wrong pair analysis (BTC for gold)",
    "domains/copilot/server/",
    "Open",
    "Phase C3",
    false,
  ],
  [
    "#44",
    "LOW",
    "Notification channels (email, webhook) are stubs",
    "shared/notifications/channels/",
    "Open",
    "Deferred",
    false,
  ],
  ...
  [
    "#47",
    "LOW",
    "Brokers page uses affiliate links, no real broker API",
    "routes/_authenticated/brokers.tsx",
    "Open",
    "Deferred",
    false,
  ],
  ...
  sections: [
    // ── COVER SECTION ──
    {
      ...
      children: [
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "Comprehensive Codebase Audit Report",
              size: 36,
              bold: true,
              color: c(P.primary),
              font: { ascii: "Calibri" },
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "47 Identified Problems  |  Full Roadmap Integration",
              size: 24,
              color: c(P.secondary),
              font: { ascii: "Calibri" },
            }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "Branch: main  |  Repo: github.com/kam65624-cmd/vixor-APP",
              size: 20,
              color: c(P.secondary),
              font: { ascii: "Calibri" },
            }),
    ...
    // ── BODY SECTION ──
    {
      ...
      children: [
        ...
        bp(
          "The remaining 42 issues span data integrity problems (mock/fake data in swap, arbitrage, whale, pulse, and community pages), architectural concerns (duplicated symbol maps, fragmented price sources, missing cache strategy), UI/UX gaps (missing localization, poor empty states), code quality issues (excessive any types, dead code), and infrastructure gaps (missing rate limiting, no retry logic for API calls).",
          [
            normal(
              "The remaining 42 issues span data integrity problems (mock/fake data in swap, arbitrage, whale, pulse, and community pages), architectural concerns (duplicated symbol maps, fragmented price sources, missing cache strategy), UI/UX gaps (missing localization, poor empty states), code quality issues (excessive any types, dead code), and infrastructure gaps (missing rate limiting, no retry logic for API calls).",
            ),
        ...
        p(
          "The audit was conducted through systematic codebase analysis of the VIXOR application repository. The methodology involved reading every major route file, server function, domain module, shared utility, and component to identify issues across eight categories: Critical Functionality, Data Integrity, Architecture, Charts & Visualization, UI/UX, Code Quality, Security & Infrastructure, and Deferred/Stubs. Each problem was classified by severity (CRITICAL, HIGH, MEDIUM, LOW), mapped to the affected file with line references, and assigned a roadmap phase for resolution. Problems marked with the new flag were identified during this audit session and were not part of the previous task backlog.",
        ),
        p(
          "The VIXOR codebase consists of approximately 300+ source files organized under src/routes (page components), src/domains (business logic), src/shared (utilities and shared state), src/components (UI primitives), and src/lib (legacy utilities). The application uses Supabase for authentication and data persistence, Binance and TwelveData for market data, DexScreener and GeckoTerminal for DEX data, and lightweight-charts for native chart rendering alongside TradingView widget embeds.",
        ),
        ...
        p(
          "Additionally, the TradingViewChart component uses Math.random() to generate container IDs (line 107), which is non-deterministic and can cause issues with React strict mode double-rendering. This should be replaced with a counter-based or useId()-based approach.",
        ),

        h2("3.2 AssetRegistry Static Bottleneck [#02]"),
        p(
          "The AssetRegistry (src/shared/asset-registry/types.ts) is designed as a static singleton with exactly 18 hardcoded asset definitions: 10 crypto pairs (BTC, ETH, SOL, BNB, XRP, ADA, DOGE, AVAX, DOT, LINK), 1 commodity (XAU/USD), 7 forex pairs, 1 index (NASDAQ), and 1 stock (AAPL). The registry is instantiated once with a fixed ASSETS array and provides lookup methods (get, find, byCategory, etc.).",
        ),
        p(
        ...
        p(
          "The home page greeting (index.tsx:38) uses English-only strings (Good Morning, Good Afternoon, Good Evening) despite the application having i18n infrastructure with Arabic and English translations. For a Telegram Mini App targeting Arabic-speaking users, this is a significant localization gap that should be addressed by using the existing useI18n hook.",
        ),
        p(
          ...
          rows: [
            new TableRow({
              ...
              children: [
                ...
                headerCell("Problem", 30),
                headerCell("File(s)", 25),
        ...
        new Table({
          ...
          rows: [
            new TableRow({
              ...
              tableHeader: true,
              children: [
                headerCell("Severity", 30),
                headerCell("Count", 20),
                headerCell("New This Audit", 25),
                headerCell("In Current Phase", 25),
              ],
            }),
            ...[
              ["CRITICAL", "5", "5", "5"],
            ...
            new TableRow({
              cantSplit: true,
              children: [
                cell("TOTAL", 30, { bold: true }),
                cell("47", 20, { bold: true }),
                cell("5", 25, { bold: true }),
                cell("47", 25, { bold: true }),
              ],
            }),
          ],
        }),
