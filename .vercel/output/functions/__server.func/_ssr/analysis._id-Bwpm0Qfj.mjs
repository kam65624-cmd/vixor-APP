...
import { u as useServerFn, n as getAnalysis } from "./router-D5kljJ2o.mjs";
import { u as useQuery } from "../_libs/tanstack__react-query.mjs";
import "../_libs/seroval.mjs";
import { i as TriangleAlert, a1 as BrainCircuit, a2 as Maximize2, a0 as X, Z as Zap, B as BookOpen, z as Target, a3 as CircleCheckBig, j as ChartNoAxesColumn, A as Activity, T as TrendingUp, X as Layers, O as ShieldCheck, g as LoaderCircle, n as ArrowLeft, a4 as Bookmark, x as Share2, N as Newspaper } from "../_libs/lucide-react.mjs";
...
function AnalysisResult() {
  ...
  const analysisQueryFn = reactExports.useCallback(async () => {
  ...
  const q = useQuery({
    ...
    refetchInterval: (query) => {
      ...
      return s === "complete" || s === "failed" ? false : 2e3;
    }
  });
