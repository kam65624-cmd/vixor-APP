...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DT9CSuJE.mjs");
...
const manifest = {
  "09f02872714842df21ec94e3628b61f650a23bd35115370b6c7ece3d29e38870": {
    functionName: "telegramSignIn_createServerFn_handler",
    importer: () => import("./auth.functions-BbiCOCfM.mjs")
  },
  "0ace32f22c4d16eaf673fe7d3d7e094b259b6c843e9c349cf22b3b6882855a02": {
    functionName: "getReferralStats_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "15759eaa899d04ff04e9ad1cabd1e199c7c64689d2fdc31cdbf9007a30b4b0f0": {
    functionName: "createStarsInvoice_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "263982a4c504a128efdcc382ea1b0c00070f6e85b64f05139230abac0c3370c0": {
    functionName: "removeFromWatchlist_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "2c0119f176938de958d67fb26b99d42e315ed1fc9265aaea8eb678cdeaf86bcb": {
    functionName: "getPointPacks_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "33881926d5c878e4eeab5fbe5cb5e6b438d9d4f0927ff423327888967544d64f": {
    functionName: "reorderWatchlist_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "33f265e4db4be4adddfe598c0a93bda016dc2d904fe367446b5c499dc8b83ef8": {
    functionName: "getEarningsEstimate_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "36a3445744a243efdaf67b3236996fbd58570a8dc07f97789b7ac0146f9944d9": {
    functionName: "updateWatchlistItem_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "3e1e0c077d06a871e84dd97344b70ec0b90583f532354802fc2ecbb2e67b94fb": {
    functionName: "getStockFundamentals_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "4aee2c8ad91a6430c80b36ba38cfbc9004928d677f312d9ba42895c8ac3d54b5": {
    functionName: "purchasePack_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "50040d38da305ba903f444031de482a2040f99d47c09127d053b1deec00974b5": {
    functionName: "getUserStrategy_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "56560c3618947f0090cbe4026dd0db0db6f04c470e3f703f6d1a0eff28f7ac95": {
    functionName: "getConsensus_createServerFn_handler",
    importer: () => import("./functions-DkfMGXZ6.mjs")
  },
  "56d21c678603db1316ddcc2fe1a6848c84fb1b82bd54f04876b45c12071fa244": {
    functionName: "getExchangeRate_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "6b6325ae9672a96c8ddc44632e93e25157252651dd340553d19c9c582ca96615": {
    functionName: "listAlerts_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "6f40d0c174f15d30503f8e639a97ecbd766cef58fd7d5f3c0abf07c52f7d0533": {
    functionName: "getPremiumPlans_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "70313b7066d6e2da049ef403539b304a38b340ac0f9c7bb9c412db665c26cc4a": {
    functionName: "getETFsDirectory_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "76bf1d3aa43b054e97a4598309659c69e2b5b8ccdf2c8d0368edd46fb0352eff": {
    functionName: "getMarketNews_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "7983147635771b2a5ae7714e0a7a2447a2233a0c10704c28872eefd6c3e6b394": {
    functionName: "claimReferral_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "7a457faa45b3c1fa572ae32995a6ee3d7db72c528fcad40fdd1d44381b9a1a6a": {
    functionName: "getETFSummary_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "7c16dbc2976d5410193676bb0a70c4bc1c3be79b9a85bfbe1ae091a769f52892": {
    functionName: "createAlert_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "80ddd1d7453278b3f23594b93366b85329acdd3d98967d885ebf84dcdd9b5c88": {
    functionName: "getGrowthEstimates_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "85de63a26211536a9320778dba4e0680a5797942881a5fa2fbd91383cdfc68d5": {
    functionName: "runAlertCheck_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "8a314d344f16bf433eda1afbc81d6758cd317eef865ef742d16b8b31401f61f8": {
    functionName: "applySignalBadgeMigration_createServerFn_handler",
    importer: () => import("./functions-CL70nb_9.mjs")
  },
  "8c47e57517d85c1adefe702a9e5d485a58da8034229fc4e6c31f79b9c2ffb89d": {
    functionName: "getCashFlow_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "936c7a0b0f8284cbcbf4a2f10a84a033f7b64fae46dc6e121086bc706ee55887": {
    functionName: "getMe_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "93d025e89f5edbbb1368403c24630e1598b373ec97db44ccf24a2938115ab6df": {
    functionName: "deleteAlert_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "9568451a3126c00a5670c7759964db85722e93c01dbe6753ad9bd0882de33afe": {
    functionName: "getAnalysis_createServerFn_handler",
    importer: () => import("./functions-CL70nb_9.mjs")
  },
  "9bef7052414747eacc16ca5da379c2da1541cd77aa865f76a6c09d34e8db9808": {
    functionName: "subscribePremium_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "a2d51f1e0fc9152933af8e6eb2eef8f5215a75eb79bfb6342cf7824f28bb1fa6": {
    functionName: "listNotifications_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "a485b6760109bf81a82e52d55abb8cece8ef86b90e8f5a490201e790f5266b5d": {
    functionName: "markAllNotificationsRead_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "ada8202f6cf246a78bfc4fce4801f4b778211acae81da5ad267bb0efe764741b": {
    functionName: "getETFPerformance_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "afdd600fd35cdd7c0b2b7062b6f0b0d206a42525c252276af1d8bc3fbbec2d81": {
    functionName: "listAnalyses_createServerFn_handler",
    importer: () => import("./functions-CL70nb_9.mjs")
  },
  "b2f1058eb9abe7132b2bdf0da8fa2ef78de3e9984c0e736fe7def23639f1a6f6": {
    functionName: "getEconomicCalendar_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "b7c8f17595638b3b4bb7cc392e22fedde3e8d3570523f7da6517882039252b78": {
    functionName: "getOHLCV_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "b862dff494b66c4ec27be600f7b502225598b72ee7fe0ad8f5819ae5c20b082f": {
    functionName: "addToWatchlist_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "bc76fdebc494d10c4912589b4857c04deb2542e50af44aed718e94c839c0f74b": {
    functionName: "generateDailySignals_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "c4f6e30f44faeccd907a664f38f0c8d2e8be02fc26367724db6c33f2f884429e": {
    functionName: "getDefaultWatchlist_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "cf6d8d037757df9bce0941f88b520a00a6b5349fd6ef187de8bad3daef588e12": {
    functionName: "getMarketPrices_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "cff80309cbab07e237e5796b2b4c160bdc8cc2c40c054a6df7fe5281b061c0cd": {
    functionName: "linkTelegramAccount_createServerFn_handler",
    importer: () => import("./functions-snanUEgK.mjs")
  },
  "d41fab665e802aeb5c547572c40ec928e1dd6419b922076a4a5ec6eb80bdc884": {
    functionName: "convertCurrency_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "d5316e52c773d2b9e2ec071cdf151055e6cdbbd7fa87f7ea422d02ad29c43c5c": {
    functionName: "askCopilot_createServerFn_handler",
    importer: () => import("./functions-DkfMGXZ6.mjs")
  },
  "dad81d8675105362ce90f60ccf1bcc24339671e8cf54c03810d0c1c4e6d7326b": {
    functionName: "getETFFullData_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "db2f626eaf510976129a670952e717d57d9170b2a3c79abef5b3cc10756c20b3": {
    functionName: "createAnalysis_createServerFn_handler",
    importer: () => import("./functions-CL70nb_9.mjs")
  },
  "deaa0de41fe3dea9abb79ad9f44c28df475be463a83e118c68377e52063c691d": {
    functionName: "getEPSTrend_createServerFn_handler",
    importer: () => import("./functions-BJa8xN7L.mjs")
  },
  "e6718beab8ddf2595fd2c2503b31860b7e642fb0a00982cb7fda2032b26cc6f9": {
    functionName: "quickAnalyze_createServerFn_handler",
    importer: () => import("./functions-CL70nb_9.mjs")
  },
  "f64bf8855da5571fb0ef6ec05b4c9be9f6a0ea502234c17b453e8a104c8790e1": {
    functionName: "getWatchlists_createServerFn_handler",
    importer: () => import("./functions-CAg8Lh46.mjs")
  },
  "fdeb62ec424b5906f3df503ca1dc04ac2234c94e79bfd0ed06e6d2356a8de7fa": {
    functionName: "updateUserStrategy_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  },
  "ff4b22a55a7bd931d3c454ffaa6ab49863b798b7de6c507daa33ef6be2d8983e": {
    functionName: "getDailySignals_createServerFn_handler",
    importer: () => import("./functions-D3eB151m.mjs")
  }
};
...
const serverEntryModule = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createServerEntry,
  default: server_default
}, Symbol.toStringTag, { value: "Module" }));
const serverEntry = server_default ?? serverEntryModule;
...
function renderDebugErrorPage(message, stack) {
  ...
  const su2 = typeof process !== "undefined" && process.env.SUPABASE_URL ? "set" : "missing";
