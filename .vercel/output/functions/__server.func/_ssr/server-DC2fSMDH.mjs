...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-umoair9m.mjs");
...
const manifest = {
  "0222c4a5f76333bcef66ddb14d20976005903d41a3839f13743d3c855f3e7abc": {
    ...
    importer: () => import("./vixor.functions-DlRTonhT.mjs")
  },
  ...
  "ca6700ae705ae6d4b0bf535d3cab0fa958f3d3d0bf825a8d98e6207a62fb4644": {
    ...
    importer: () => import("./auth.functions-DBeOxiMS.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-XLp9U_og.mjs").then((n) => n.B),
    import("./start-BtHf8iya.mjs"),
