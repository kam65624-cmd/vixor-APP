...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DL2xb5oZ.mjs");
...
const manifest = {
  "1be115425d998b8b2f28b2d572d52b6b6eb1428db38069c10841ff9887ca5d9c": {
    ...
    importer: () => import("./vixor.functions-D1zus-wC.mjs")
  },
  ...
  "ca6700ae705ae6d4b0bf535d3cab0fa958f3d3d0bf825a8d98e6207a62fb4644": {
    ...
    importer: () => import("./auth.functions-EcgIXUlx.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CpOILtp4.mjs").then((n) => n.r),
    import("./start-BwPQaro5.mjs"),
