...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DL0YY-u3.mjs");
...
const manifest = {
  "1be115425d998b8b2f28b2d572d52b6b6eb1428db38069c10841ff9887ca5d9c": {
    ...
    importer: () => import("./vixor.functions-Dhxt0941.mjs")
  },
  ...
  "ca6700ae705ae6d4b0bf535d3cab0fa958f3d3d0bf825a8d98e6207a62fb4644": {
    ...
    importer: () => import("./auth.functions-CmHMizZa.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BBF5Hwjm.mjs").then((n) => n.r),
    import("./start-HfFRlmK6.mjs"),
