...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CD4ZX6_0.mjs");
...
const manifest = {
  "0222c4a5f76333bcef66ddb14d20976005903d41a3839f13743d3c855f3e7abc": {
    ...
    importer: () => import("./vixor.functions-DpQ9k7jE.mjs")
  },
  ...
  "ca6700ae705ae6d4b0bf535d3cab0fa958f3d3d0bf825a8d98e6207a62fb4644": {
    ...
    importer: () => import("./auth.functions-CWOwgfgV.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-uhgHfevS.mjs").then((n) => n.A),
    import("./start-C0U-fEt-.mjs"),
