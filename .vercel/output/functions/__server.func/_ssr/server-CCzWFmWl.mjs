...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BN4W2nE2.mjs");
...
const manifest = {
  "1be115425d998b8b2f28b2d572d52b6b6eb1428db38069c10841ff9887ca5d9c": {
    ...
    importer: () => import("./vixor.functions-CNXoKXk0.mjs")
  },
  ...
  "ca6700ae705ae6d4b0bf535d3cab0fa958f3d3d0bf825a8d98e6207a62fb4644": {
    ...
    importer: () => import("./auth.functions-BYWfC8p6.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D5kljJ2o.mjs").then((n) => n.r),
    import("./start-Dkcz3WuW.mjs"),
