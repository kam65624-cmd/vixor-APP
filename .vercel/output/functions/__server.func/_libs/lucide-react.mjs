...
const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$11);
const __iconNode$10 = [
...
const ShieldQuestionMark = createLucideIcon("shield-question-mark", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
