...
import { MemeSections } from "./MemeSections";
import { CryptoSections } from "./CryptoSections";
import { TokenTradeRow } from "./TradeRow";
import {
  MarketStat,
  QuickCalcRow,
  MetricCard,
...
export function TokenPage() {
  ...
  // ── Telegram WebView: hide DEXTools link (blocked by CSP in Telegram) ──
  const showDexTools = !isTelegramWebView();
        ...
        <PageScrollArea>
          ...
          {pairAddress && chainFromDiscover ? (
            ...
            >
              ...
              {showDexTools && pairAddress && chainFromDiscover && (
                <DexToolsButton
                  chainId={chainFromDiscover}
                  pairAddress={pairAddress}
                  label="DEXTools"
