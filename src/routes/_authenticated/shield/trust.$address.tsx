...
const MOCK_TRUST_DATA = {
  tokenName: "MoonDoge Rocket",
  symbol: "MDR",
  chain: "Ethereum",
  contractAddress: "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D",
  overallScore: 67,
  verdict: "EXERCISE CAUTION" as const,
  categories: [
    {
      name: "Contract Safety",
      score: 82,
      description: "Source verified, no proxy, ownership renounced",
    },
    {
      name: "Liquidity",
      score: 55,
      description: "LP partially locked, moderate depth",
    },
    {
      name: "Holder Distribution",
      score: 48,
      description: "Top 10 holders control 42% of supply",
    },
    {
      name: "Team Transparency",
      score: 71,
      description: "Team doxxed with KYC, social profiles active",
    },
    {
      name: "Trading Activity",
      score: 79,
      description: "Healthy volume, consistent buy/sell ratio",
    },
  ] as TrustCategory[],
  riskFlags: [
    {
    ...
    {
      id: "rf2",
      name: "Concentrated Holder Risk",
      severity: "high",
      description:
        "Top wallet holds 18.5% of total supply. Large sell could impact price significantly.",
      detectedAt: "2025-01-14T06:30:00Z",
    },
    {
      id: "rf3",
    ...
    },
    {
      ...
      severity: "low",
      description:
        "Sell tax of 3% detected. Acceptable for most strategies but reduces short-term profitability.",
  ...
  relatedAlerts: [
    {
      id: "ra1",
      title: "Large Transfer Detected — 5M MDR moved",
      severity: "high",
      timeAgo: "2h ago",
    },
    {
      id: "ra2",
      title: "LP Pair Rebalanced on Uniswap",
      severity: "medium",
      timeAgo: "8h ago",
    },
    {
      id: "ra3",
      title: "New Holder Accumulation Pattern",
      severity: "critical",
      timeAgo: "1d ago",
    },
  ] as RelatedAlert[],
