...
function PulsePage() {
  return (
    <div style={{ background: "#0f1424", color: "#F0F4FC", fontFamily: "'Inter', system-ui, sans-serif", minHeight: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      ...
      <h1 style={{ fontSize: "22px", fontWeight: 800, marginBottom: "8px" }}>Market Pulse</h1>
      <p style={{ fontSize: "13px", color: "#7B8BA8", textAlign: "center", maxWidth: "360px", lineHeight: 1.6, marginBottom: "24px" }}>
        Real-time market activity feed with volume spikes, whale movements, social trends, price breakouts, and smart money activity.
      </p>
      <div style={{ display: "flex", gap: "8px" }}>
        ...
        <span style={{ fontSize: "10px", fontWeight: 600, padding: "4px 10px", borderRadius: "4px", background: "rgba(59,130,246,0.08)", color: "#60A5FA" }}>Requires: pulse_signals table</span>
      </div>
    </div>
  );
}