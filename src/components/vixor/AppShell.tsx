...
const tabs = [
  ...
  { to: "/portfolio", label: "Portfolio", icon: Briefcase, match: (p: string) => p.startsWith("/portfolio") || p.startsWith("/journal") || p.startsWith("/trade-desk") || p.startsWith("/charts") || p.startsWith("/signals") },
] as const;
