...
function SkeletonCard({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      {...props}
    >
      <div className="h-4 w-2/3 rounded-md bg-muted-foreground/10" />
      <div className="h-8 w-1/2 rounded-md bg-muted-foreground/10" />
      <div className="h-3 w-1/3 rounded-md bg-muted-foreground/10" />
    </div>
  );
}
  ...
  return (
    <div className={cn("flex items-center gap-3 py-3 px-4 animate-pulse", className)} {...props}>
      ...
      <div className="flex-1 space-y-2">
        <div className="h-3.5 w-1/3 rounded-md bg-muted-foreground/10" />
        <div className="h-3 w-1/5 rounded-md bg-muted-foreground/10" />
      </div>
      <div className="h-4 w-16 rounded-md bg-muted-foreground/10 text-right" />
    </div>
  );
}
