...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-lg px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-[0.04em] leading-[1.4] transition-colors",
  {
    variants: {
      variant: {
        ...
        wait: "border border-[var(--neutral-wait)]/20 bg-[var(--neutral-wait)]/10 text-[var(--neutral-wait)]",
        ...
        muted: "border border-border bg-white/5 text-muted-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
