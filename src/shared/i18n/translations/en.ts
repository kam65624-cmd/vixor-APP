const en = {
  ...
  dashboard: {
    ...
    calendarComingSoon:
      "Track FOMC, NFP, CPI, and 50+ economic events that move forex, crypto, and commodities markets.",
  ...
  analysis: {
    ...
    disclaimerText:
      "This analysis is generated by Vixor AI based on technical patterns and fundamental data. It is not financial advice. Always apply your own risk management and judgment before executing any trade.",
  ...
  journal: {
    ...
    revengeTradingDesc:
      "You've taken consecutive trades after hitting your stop loss. Consider taking a break.",
    // Notes tab
    newNote: "New Note",
    editNote: "Edit Note",
  ...
  profile: {
    ...
    tradeJournalDesc: "Track your trades and review performance",
    tradeDesk: "Trade Desk",
    tradeDeskDesc: "Risk calculator and position management",
    referralsDesc: "{count} friends invited",
    premium: "Premium",
    notifications: "Notifications",
    settings: "Settings",
    signOut: "Sign Out",
