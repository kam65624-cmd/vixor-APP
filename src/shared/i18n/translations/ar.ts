...
const ar: Translations = {
  ...
  nav: {
    ...
    more: {
      ...
      items: {
        radar: "الرادار",
        pulse: "النبض والحيتان",
        predictions: "التوقعات",
        dailyLoop: "الحلقة اليومية",
  ...
  journal: {
    ...
    noNotesDesc: "ابدأ بتدوين أفكارك وأسواقك ودروسك.",
    ...
    allPairs: "كل الأزواج",
    allMoods: "كل المزاجات",
    addNote: "إضافة ملاحظة",
    linkedAnalysis: "تحليل مرتبط",
  ...
  profile: {
    ...
    tradeJournalDesc: "تتبع صفقاتك وراجع الأداء",
    tradeDesk: "مكتب التداول",
    tradeDeskDesc: "حاسبة المخاطرة وإدارة الصفقات",
    referralsDesc: "{count} صديق مدعو",
    premium: "بريميوم",
    notifications: "الإشعارات",
    settings: "الإعدادات",
  ...
  backtest: {
    title: "اختبار رجعي",
    subtitle: "اختبر استراتيجياتك على البيانات التاريخية",
    selectPair: "اختر الزوج",
    selectTimeframe: "الإطار الزمني",
    selectStrategy: "الاستراتيجية",
    initialCapital: "رأس المال الأولي",
    riskPercent: "نسبة المخاطرة",
    startDate: "تاريخ البدء",
    endDate: "تاريخ الانتهاء",
    runBacktest: "تشغيل الاختبار الرجعي",
    running: "جاري تشغيل الاختبار الرجعي...",
    results: "النتائج",
    totalPnl: "إجمالي الربح والخسارة",
    winRate: "نسبة الربح",
  ...
  experiments: {
    title: "التجارب",
    subtitle: "طوّر استراتيجيات فائزة بالخوارزميات الوراثية",
    newExperiment: "تجربة جديدة",
    totalExperiments: "الإجمالي",
    completed: "مكتملة",
    bestScore: "أفضل نتيجة",
    experimentName: "اسم التجربة",
    assetSymbol: "الأصل",
    timeframe: "الإطار الزمني",
    strategyTemplate: "قالب الاستراتيجية",
    generations: "الأجيال",
    populationSize: "حجم المجتمع",
    startExperiment: "بدء التجربة",
    starting: "جاري بدء التجربة...",
