  ...
  plugins: [
    ...
    nitro({
        ...
        "/**": {
          headers: {
            ...
            "Content-Security-Policy": [
              ...
              "img-src 'self' data: blob: https: https://s3.tradingview.com https://cdn.dexscreener.com",
      ...
      handlers: [
        ...
        { route: "/api/vixor-ai/coach", handler: "./server/api/vixor-ai/coach.ts" },
        { route: "/api/vixor-ai/feedback", handler: "./server/api/vixor-ai/feedback.ts" },
        { route: "/api/vixor-ai/weekly-report", handler: "./server/api/vixor-ai/weekly-report.ts" },
      ],
    }),
    viteReact(),
  ],
