...
<div class="map-block r-16x10 tone-paper">
  <img
    src="https://api.mapbox.com/styles/v1/mapbox/light-v11/static/.../1200x675@2x?access_token=..."
    alt="Lhasa walking route"
  />
...
<div class="map-block r-16x10">
  ...
  <div class="map-pin" style="left:32%; top:48%;">
    ...
    <div class="line"></div>
    <div class="card">
      <div class="name">大昭寺</div>
      <span class="meta">DAY 1</span>
    </div>
  </div>
  <div class="map-pin accent" style="left:62%; top:38%;">
    ...
    <div class="line"></div>
    <div class="card">
      <div class="name">布达拉宫</div>
      <span class="meta">DAY 2 · 18:40 SUNSET</span>
    </div>
  </div>
...
Pins sit _outside_ the SVG, as HTML siblings — they get the `.frame-shot` treatment for free.
...
- **Tracing a real map into SVG** — schematic should _abstract_, not replicate. If a viewer can guess the city from your SVG alone, you over-traced.
