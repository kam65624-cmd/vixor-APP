...
.hero {
  background: radial-gradient(ellipse at 30% 20%, #1a0a2e 0%, #05060f 55%, #000 100%);
}
#ascii-nebula {
  color: #a87bd6;
} /* 星云 */
...
.hero {
  background: linear-gradient(180deg, #f3e4d4 0%, #e9d2b8 100%);
}
#ascii-nebula {
  color: #b88a6a;
  opacity: 0.5;
...
.hero {
  background: radial-gradient(ellipse at 70% 30%, #4a0e6e 0%, #0a0118 60%, #000 100%);
}
#ascii-nebula {
  color: #b14aff;
  opacity: 0.55;
...
.hero {
  background: radial-gradient(ellipse at center, #052010 0%, #000800 70%, #000 100%);
}
#ascii-nebula {
  color: #2a8a44;
  opacity: 0.45;
...
.hero {
  background: linear-gradient(160deg, #1a3548 0%, #0c1420 50%, #050810 100%);
}
#ascii-nebula {
  color: #b8a4ff;
  opacity: 0.5;
...
.hero {
  background: radial-gradient(ellipse at 50% 80%, #5a1f10 0%, #1a0a05 60%, #000 100%);
}
#ascii-nebula {
  color: #a8765a;
  opacity: 0.5;
