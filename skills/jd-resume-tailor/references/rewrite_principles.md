...
JD 说"主导 \_\_\_ 系统设计"，如果你是这段经历的负责人，把"参与"改成"主导"。

但**前提是真的主导**——agent 在改写前必须确认：

- 这段经历你是 leader 吗？是的话改"主导"；不是就保留"参与"或写明"作为 \_ 角色 协助 \_\_\_"
...
Summary 改成："5 年 C 端互联网产品经验，主导过 \_\_\_ 增长项目，熟练使用 SQL 与 A/B 测试驱动决策"
