...
new Paragraph({
  ...
  spacing: { before: 0, after: 200, line: Math.ceil(26 * 23), lineRule: "atLeast" },
  children: [
    new TextRun({
      text: "XX Municipal Government",
...
new Paragraph({
  border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: "FF0000" } },
  spacing: { after: 40 },
  children: [],
});
```
