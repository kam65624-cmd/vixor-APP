...
> Source: `src/styles.css` — VIXOR Design System V5 (Premium Trading 2026/2027)
...
5. **3-layer surface depth**: background → card → surface-elevated — maintain visual hierarchy
